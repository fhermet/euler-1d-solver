...
$$
s\llbracket \mathbf{U} \rrbracket = \llbracket \mathbf{F}(\mathbf{U}) \rrbracket
$$

où $\llbracket Q \rrbracket = Q_R - Q_L$ désigne le saut de la quantité $Q$ à travers la discontinuité.
