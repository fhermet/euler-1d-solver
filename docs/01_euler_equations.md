...
$$
s\lbrack\!\lbrack \mathbf{U} \rbrack\!\rbrack = \lbrack\!\lbrack \mathbf{F}(\mathbf{U}) \rbrack\!\rbrack
$$

où $\lbrack\!\lbrack Q \rbrack\!\rbrack = Q_R - Q_L$ désigne le saut de la quantité $Q$ à travers la discontinuité.
