...
Ici $\Delta u = u_R - u_L = 7.0$, soit **93%** du seuil. La pression de la zone etoile est extremement faible : $p^\ast \sim 10^{-13}$.
...
L'etat intermediaire atteint une pression tres elevee ($p^\ast \approx 1700$) et une densite elevee, creant des conditions post-choc extremes.
